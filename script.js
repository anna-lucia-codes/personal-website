const projectMeta = {
  'emailart.html':        { title: 'Reply All', year: '2025 - now', tags: ['digital'], desc: 'A newsletter in which every email is a unique artwork made of HTML.'},
  'oefenstof.html':       { title: 'Oefenstof', year: '2025',       tags: ['textile'], desc: 'Machine embroideries that investigate the relationship between traditional cross-stitch samplers and classical computational patterns.'},
  'thread.html':          { title: 'Thread', year: '2025', tags: ['digital'], desc: 'Long-form generative art collection as on-screen counterpart to Oefenstof.' },
  'synths.html':          { title: 'Synths', year: '2024',       tags: ['print'], desc: 'Five limited edition fine art prints, developed and curated from two algorithms.' },
  '33million.html':       { title: '33 Million', year: '2024',       tags: ['digital', 'textile'], desc: '122 digital works and 33 embroideries from an algorithm rearranging patterns of historical needlework samplers.' },
  'yesyesno.html':        { title: '{yes, yes, no, yes}', year: '2024 - now', tags: ['tattoo'], desc: 'Limited edition generative tattoo project; a parametric system to generate and select a personalized glyph.' },
  'generations.html':     { title: 'Generations', year: '2023',       tags: ['digital', 'textile', 'collaboration'], desc: 'Collaboration with the Gees Bend Quiltmakers translating their legacy of improvisation and material reuse into a generative algorithm.' },
  'AFWIPS.html':          { title: 'Art For Walls In Public Spaces', year: '2022',     tags: ['digital'], desc: 'Long-form generative art series as a ambient system for public spaces.' },
  'perpetual.html':       { title: 'Perpetual Oscillations', year: '2022',       tags: ['digital'], desc: 'Long-form generative art series as a ambient system for any screen.' },
  'patchedparadise.html': { title: 'Patched Paradise', year: '2023',       tags: ['digital'], desc: 'Generative series treating code as a material and exploring the tension between computational structure and the intuitive, material logic of textile craft.' },
  'loom.html':            { title: 'Loom', year: '2021',       tags: ['digital'], desc: 'Long-form generative algorithm emulating a four-shaft weaving loom according to a digital punching card.' },
};
